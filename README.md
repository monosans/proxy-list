...
| [`proxies/http.txt`](https://raw.githubusercontent.com/monosans/proxy-list/main/proxies/http.txt)       | HTTP only, no `protocol://` prefix       |
| [`proxies/socks4.txt`](https://raw.githubusercontent.com/monosans/proxy-list/main/proxies/socks4.txt)   | SOCKS4 only, no `protocol://` prefix     |
| [`proxies/socks5.txt`](https://raw.githubusercontent.com/monosans/proxy-list/main/proxies/socks5.txt)   | SOCKS5 only, no `protocol://` prefix     |
...
A line is `host:port`, or `username:password@host:port` for a proxy that needs credentials, with `protocol://` in front of either in `all.txt`.
